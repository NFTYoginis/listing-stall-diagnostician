# Fixture — 07 — no integrity verdict
...
**Planted defect:** The integrity section discusses the comparison set at length but never states the verdict, so a weak baseline would pass without anyone noticing it was never graded.

## Metadata

- source case: `tests/case-02-expectation-mismatch/inputs.md`
- gate that must reject it: `SET-INTEGRITY`
...
Geography, band, type, size and window match across the set. Condition

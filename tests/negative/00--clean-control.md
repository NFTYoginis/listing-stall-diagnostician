...
**Planted defect:** none. This one must pass every gate; a checker that only ever rejects proves as little as one that only ever accepts.

## Metadata

- source case: `tests/case-02-expectation-mismatch/inputs.md`
- gate that must reject it: `(none — positive control)`

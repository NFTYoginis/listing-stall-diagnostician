...
**Planted defect:** The mechanism is restated as a label instead of traced to this listing's evidence, collapsing three levels into two.

## Metadata

- source case: `tests/case-02-expectation-mismatch/inputs.md`
- gate that must reject it: `THREE-LEVEL`

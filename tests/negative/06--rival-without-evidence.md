# Fixture — 06 — rival without evidence
...
**Planted defect:** A rival is named and demoted with no eliminating evidence attached, which is a list of dismissals wearing the demotion section's name.

## Metadata

- source case: `tests/case-02-expectation-mismatch/inputs.md`
- gate that must reject it: `RULED-OUT`

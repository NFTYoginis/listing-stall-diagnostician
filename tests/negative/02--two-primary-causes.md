...
**Planted defect:** The primary cause is hedged into two causes mid-sentence, which is the shape a flat audit takes when it is wearing a diagnosis's headings.

## Metadata

- source case: `tests/case-02-expectation-mismatch/inputs.md`
- gate that must reject it: `ONE-CAUSE`
...
**Expectation mismatch.** On this record the finding is best read as a combination of expectation mismatch and post-visit value judgement, with the two acting together at the same stage.

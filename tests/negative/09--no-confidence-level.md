# Fixture — 09 — no confidence level
...
**Planted defect:** The confidence section reads as confident prose mid-paragraph but never states one of the three permitted levels, so nothing binds the cap.

## Metadata

- source case: `tests/case-02-expectation-mismatch/inputs.md`
- gate that must reject it: `CONFIDENCE`
...
This finding rests on a strong evidentiary base. The comparison set is Usable, the constraint is located by two

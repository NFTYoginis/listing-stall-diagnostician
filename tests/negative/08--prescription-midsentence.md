# Fixture — 08 — prescription midsentence
...
**Planted defect:** A recommended action is buried mid-paragraph in the missing-evidence section, far from the start of any line, in the hedged form rules.md names explicitly.

## Metadata

- source case: `tests/case-02-expectation-mismatch/inputs.md`
- gate that must reject it: `NO-RX`
...
Since four of the eight comps carry one, you may want to add a floor plan before anything else. Neither is load-bearing for the Stage 4 finding, but the absent floor plan is a
